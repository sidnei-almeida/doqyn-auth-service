...
PUBLIC_APP_URL="$(prompt_default "URL pública do app (alpha)" "${ALLOWED_ORIGINS}")"
...
echo ""
read -r -p "OAUTH_GOOGLE_CLIENT_ID (opcional): " OAUTH_GOOGLE_CLIENT_ID
echo -n "OAUTH_GOOGLE_CLIENT_SECRET (opcional): "
